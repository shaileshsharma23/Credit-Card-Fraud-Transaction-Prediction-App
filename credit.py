...
loaded_model= pickle.load(open("https://github.com/shaileshsharma23/Credit-Card-Fraud-Transaction-Prediction-App/blob/main/trained_card.sav","rb"))
...
def main():
    ...
    if st.button("result"):
        card_fraud=card_pred([Time,V1,V2,V3,V4,V5,V6,V7,V8,V9,V10,V11,V12,V13,V14,V15,V16,
